                            ...
                            <div id="progressSection" class="col-xs-12" style="display:none">
                                ...
                                <div class="col-md-3 col-sm-3 col-xs-6">
                                    <div class="form-group">
                                        ...
                                        <select id="updateTaskProgress" class="form-control" id="updateTaskProgress"><option>NOT STARTED</option><option>IN PROGRESS</option><option>COMPLETED</option></select>
                                    </div>
                                </div>
